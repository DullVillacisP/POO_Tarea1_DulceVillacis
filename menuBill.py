...
from utilities import reset_color,cyan_color, yellow_color, red_color
...
class CrudClients(ICrud):
    def create(self):
        ...
        while True:
            ...
            gotoxy(2,2);print(yellow_color+"██"+" "*34+"INGRESO DE CLIENTE"+" "*34+"██")
    ...
    def update(self):
        ...
        gotoxy(7,4);dni = print(yellow_color+"Ingrese el dni del cliente a actualizar: ")
    ...
    # Guardar los cambios en el archivo JSON de productos
            ...
            gotoxy(15,12);print(yellow_color+"Cliente actualizado exitosamente. :3")
        else:
    ...
    def delete(self):
        ...
        if client:
            gotoxy(7,6);print(yellow_color + "DATOS DEL CLIENTE:" + reset_color)
            gotoxy(15,7);headers = "DNI".ljust(15) + "NOMBRE".ljust(20) + "APELLIDO".ljust(20) + "VALOR".ljust(15)
            gotoxy(10,8);print(yellow_color + "█" * len(headers) + reset_color)
            gotoxy(15,9);print(headers)
            gotoxy(10,10);print(yellow_color + "█" * len(headers) + reset_color)
            ...
            for find in client:
                ...
                gotoxy(10,12);print(yellow_color + "█" * len(headers) + reset_color)
                    
            gotoxy(4,14);print(yellow_color+"Está seguro de eliminar el cliente? (s/n): ")
    ...
    def consult(self):
        ...
        json_file = JsonFile(path+'/archivos/clients.json')
        gotoxy(2,2);json_file.read()
        gotoxy(7,5);print("Ingrese el dni del cliente para consultar: ")
        dni=validar.cedula("Error: debe contener 10 dígitos",50,5)
        client = json_file.find('dni',dni)
        if client:
            gotoxy(7,6);print(yellow_color + "DATOS DEL CLIENTE:" + reset_color)
            ...
            for find in client:
                ...
                gotoxy(15,11);print(client_info)
                gotoxy(10,12);print(yellow_color + "█" * len(headers) + reset_color)
            gotoxy(30,13);print(yellow_color+"😊 Gracias por consultar 😊"+reset_color)
...
class CrudProducts(ICrud):
    ...
    def delete(self):
        ...
        gotoxy(30,2);print(red_color+"Eliminación de Producto")
        ...
        if product_id.isdigit():
            ...
            gotoxy(20,15);print(red_color+"❗El ID no es válido❗"+reset_color)  
    ...
    def consult(self):
        ...
        gotoxy(8,5);print("Ingrese ID del Producto: ", end='')
        product_id = input()
        ...
        if products:
            gotoxy(15,7);print(red_color+"ID".ljust(10) + "DESCRIPCIÓN".ljust(25) + "PRECIO".ljust(15) + "STOCK".ljust(10))
            gotoxy(15,8);print("-" * 60)

            # Detalles del producto
            for product in products:
                gotoxy(15,9);print(str(product['id']).ljust(10) + product['descripcion'].ljust(25) + f"{product['precio']:.2f}".ljust(15) + str(product['stock']).ljust(10)+reset_color)
            gotoxy(30,13);print("😊 Gracias por consultar 😊")
        else:
            gotoxy(2,7);print(red_color + "El producto con el ID proporcionado no se encuentra." + reset_color)
        
        # Pie de página
        gotoxy(2,11);print(red_color + "█" * 90 + reset_color)
        gotoxy(3,14);input("Presione una tecla para continuar...")
...
class CrudSales(ICrud):
    ...
    def update(self):
        ...
        for fac in invoices:
            ...
            gotoxy(9, f);print(f"{id_str}{fecha_str}{cliente_str}{total_str}")
            f += 1
        gotoxy(7,4);print("Ingrese el ID de la factura a actualizar: ")
        gotoxy(7,4);invoice_number = validar.solo_numeros("Error: Solo Numeros",49,4)
        borrarPantalla()
            ...
            for invoice in invoices:
                if invoice["factura"] == invoice_number:
                    ...
                    if opcion == '1':
                        ...
                        gotoxy(7,14);nuevo_cliente = validar.solo_letras("Error: Solo letras",32,14).lower().capitalize()
